...
```{r}
eq_out_plot <- ggplot(eq_out_prob, aes(x=demo, y=q, fill=firstgen)) + geom_bar(stat = "identity", position= "dodge") + coord_flip()+
...
```{r}
eq_ind_plot <- ggplot(eq_ind_prob, aes(x=demo, y=qdiff, fill=firstgen)) + geom_bar(stat = "identity", position= "dodge") + 
