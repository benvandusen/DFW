...
intro_m_final1 <- glmer(intro_mod_final1, data=red_introPhys,family = binomial)
intro_mod_final2 <- (DDFW ~ FG_Status*LA + Female*LA + nonwhite*LA + FG_Status*nonwhite + NULLGender + (1|courID))
intro_m_final2 <- glmer(intro_mod_final2, data=red_introPhys,family = binomial)
summary(intro_m_uncond)
summary(intro_m_overall)
summary(intro_m_finalold)
summary(intro_m_final1)
summary(intro_m_final2)
ICC <- 0.3102/(0.3102+pi^2/3)
```
