...
phys_courses_prob$course <- factor(c("204A", "204A", "204B", "204B", "204C", "204C", "202A", "202A", "202B", "202B"))
phys_courses_prob$instruction <- factor(c("Traditional", "LA", "Traditional", "LA", "Traditional", "LA", "Traditional", "LA", "Traditional", "LA"))
phys_courses_prob$math <- factor(c("Calculus-based", "Calculus-based", "Calculus-based", "Calculus-based", "Calculus-based", "Calculus-based", "Algebra-based", "Algebra-based", "Algebra-based", "Algebra-based"))
phys_courses_prob$semester <- factor(c("1st", "1st", "2nd", "2nd", "3rd", "3rd", "1st", "1st", "2nd", "2nd"))
...
desc2 <- red_phys %>% group_by(courID) %>% summarise(N = length(DDFW),
              DDFW_mean = mean(DDFW),
             DDFW_N = sum(DDFW),
             LA_mean = mean(LA),
             LA_N = sum(LA),
